...
export default function NewIncomingRequestPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (res.ok) {
        router.push('/tmc-requests/incoming');
      } else {
  ...
  return (
    <DashboardLayout>
      <PageHeader title="Новая входящая заявка" subtitle="Создание заявки на поступление ТМЦ" />
          ...
          <div className="card-body space-y-4">
            <div>
              ...
              <input
                ...
                placeholder="Например: Поступление запчастей от поставщика"
              />
            </div>
            <div>
