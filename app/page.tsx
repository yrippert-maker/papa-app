  ...
  return (
    <DashboardLayout>
      <main className="p-6 lg:p-7">
        <h2 className="text-lg font-bold text-slate-900 dark:text-white mb-6">Дашборд</h2>

        <div className="mb-8">
          <h3 className="text-xs font-semibold uppercase tracking-wider text-slate-500 dark:text-slate-400 mb-4">KPI</h3>
