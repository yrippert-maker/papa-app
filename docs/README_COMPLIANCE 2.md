...
- **v1.0.1** — Финальный baseline (full delivery): dashboard, health alerts, trust package. Regulatory bundle: `regulatory-bundle-v1.0.1.zip`; SHA-256 — см. [REGULATORY_SUBMISSION_CHECKLIST.md](./REGULATORY_SUBMISSION_CHECKLIST.md) (записать после сборки на чистом дереве).
