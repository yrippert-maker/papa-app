...
export const ROUTE_REGISTRY = [
  ...
  { method: 'GET', path: '/api/tmc/items', permission: 'TMC.VIEW' },
  { method: 'GET', path: '/api/tmc/lots', permission: 'TMC.VIEW' },
...
export const VALID_PERMISSIONS = new Set([
  ...
  'ADMIN.MANAGE_USERS', 'TMC.VIEW', 'TMC.MANAGE', 'TMC.REQUEST.VIEW',
]);
